error id: jvdfZflPImMY+LDCgC8+gA==
### Bloop error:

Unexpected error when compiling scalation: java.io.FileNotFoundException: <WORKSPACE>\src\main\scala\scalation\animation\DgAnimator.scala (The process cannot access the file because it is being used by another process)
...
Unexpected error when compiling scalation: java.io.FileNotFoundException: <WORKSPACE>\src\main\scala...